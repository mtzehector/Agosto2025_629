...
import mx.att.digital.customermanagement.interfaces.dto.CustomerDeleteEventPayload;
...
public class CustomerDeleteEvent implements Serializable {
  ...
  public CustomerDeleteEvent timeOccurred(LocalDateTime timeOccurred) {
  ...
  public CustomerDeleteEvent eventTime(LocalDateTime eventTime) {
