...
public class CustomerAttributeValueChangeEvent implements Serializable {
  ...
  public CustomerAttributeValueChangeEvent timeOccurred(LocalDateTime timeOccurred) {
  ...
  public CustomerAttributeValueChangeEvent eventTime(LocalDateTime eventTime) {
