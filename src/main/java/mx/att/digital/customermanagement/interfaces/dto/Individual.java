...
public class Individual extends Party implements Serializable, PartyOrPartyRole {
  ...
  public Individual birthDate(LocalDateTime birthDate) {
  ...
  public Individual deathDate(LocalDateTime deathDate) {
