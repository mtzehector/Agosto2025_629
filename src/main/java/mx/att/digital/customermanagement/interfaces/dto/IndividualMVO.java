...
public class IndividualMVO extends PartyMVO implements Serializable, PartyOrPartyRoleMVO {
  ...
  public IndividualMVO birthDate(LocalDateTime birthDate) {
  ...
  public IndividualMVO deathDate(LocalDateTime deathDate) {
