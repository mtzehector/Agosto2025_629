...
public interface NotificationListenerApiDelegate {
     ...
     * @see NotificationListenerApi#customerAttributeValueChangeEvent
     */
     ...
     * @return Notified (status code 204)
     *         or Error (status code 200)
     * @see NotificationListenerApi#customerCreateEvent
     */
     ...
     * @return Notified (status code 204)
     *         or Error (status code 200)
     * @see NotificationListenerApi#customerDeleteEvent
     */
     ...
     * @return Notified (status code 204)
     *         or Error (status code 200)
     * @see NotificationListenerApi#customerStateChangeEvent
     */
