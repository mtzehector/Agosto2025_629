...
public class IndividualFVO extends PartyFVO implements Serializable, PartyOrPartyRoleFVO {
  ...
  public IndividualFVO birthDate(LocalDateTime birthDate) {
  ...
  public IndividualFVO deathDate(LocalDateTime deathDate) {
