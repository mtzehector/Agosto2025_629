...
import mx.att.digital.customermanagement.interfaces.dto.CustomerCreateEventPayload;
...
public class CustomerCreateEvent implements Serializable {
  ...
  public CustomerCreateEvent timeOccurred(LocalDateTime timeOccurred) {
  ...
  public CustomerCreateEvent eventTime(LocalDateTime eventTime) {
